(function() {
    ...
    angular.module('BlurAdmin.pages.transbox.database.opo')
        .controller('DoctorPageCtrl', DoctorPageCtrl)
        .controller('DoctorModalCtrl', DoctorModalCtrl);

    function DoctorPageCtrl($scope, $filter, editableOptions, editableThemes, Http, Config, $uibModal, toastr, toastrConfig) {
    ...
    // modal controller
    function DoctorModalCtrl($scope) {
