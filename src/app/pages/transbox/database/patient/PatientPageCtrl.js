(function() {
    ...
    angular.module('BlurAdmin.pages.transbox.database.patient')
        .controller('PatientPageCtrl', PatientPageCtrl)
        .controller('PatientModalCtrl', PatientModalCtrl);

    function PatientPageCtrl($scope, $filter, editableOptions, editableThemes, Http, Config, $uibModal, toastr, toastrConfig) {
    ...
    // modal controller
    function PatientModalCtrl($scope) {
